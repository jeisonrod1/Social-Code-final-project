    ...
    <BodyForm onSubmit={handleSubmit}>
        ...
        <InputGridDiv>
            <InputItemDiv>
                ...
                <InputItemInputField value={title} onChange={handleTitleChange}></InputItemInputField>
            </InputItemDiv>
            <InputItemDiv>
                <InputItemTitle>Language *</InputItemTitle>
                <InputItemSelectField value={language} onChange={handleLanguageChange}>
            ...
            <InputItemDiv>
                ...
                <InputItemInputField value={tags} onChange={handleTagsChange}></InputItemInputField>
            </InputItemDiv>
            <InputItemDiv>
                <InputItemTitle>Difficulty Level</InputItemTitle>
                <InputItemInputField value={difficulty} onChange={handleDifficultyChange}></InputItemInputField>
            </InputItemDiv>
            <InputItemDiv>
                <InputItemTitle>Description</InputItemTitle>
                <InputItemInputField value={description} onChange={handledDescriptionChange}></InputItemInputField>
            </InputItemDiv>
            <InputItemDiv>
